...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunitySafeArea", path: "../../../node_modules/.pnpm/@capacitor-community+safe-area@8.0.1_@capacitor+core@8.5.1/node_modules/@capacitor-community/safe-area"),

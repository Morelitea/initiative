...
export const generate_keys: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
export const inspect_prekey: (a: number, b: number) => [number, number, number];

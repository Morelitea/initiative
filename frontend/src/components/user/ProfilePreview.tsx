 ...
 * avatar, trophies, status and footer the page draws, so what you see here
...
export const ProfilePreview = ({
  ...
  return (
    <Card className="overflow-hidden pt-0">
      ...
      />
      <ProfileTrophies decorations={decorations} className="-mt-6 px-2" />
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="flex min-w-0 flex-1 flex-wrap items-center pb-1">

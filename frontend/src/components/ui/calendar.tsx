...
import { DayFlag, DayPicker, SelectionState, UI, type CustomComponents } from "react-day-picker";
...
const CalendarChevron = ({ orientation = "right", className, size, disabled }: ChevronProps) => {
  const Icon =
    orientation === "left"
      ? ChevronLeft
      : orientation === "right"
...
export const Calendar = ({
  ...
  const defaultClassNames = {
    [UI.Nav]: "absolute inset-x-3 top-3 z-10 flex sm:p-2 items-center justify-between gap-2",

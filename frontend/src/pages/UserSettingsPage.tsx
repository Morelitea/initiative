...
export const UserSettingsPage = () => {
  ...
  const [notificationTime, setNotificationTime] = useState(user?.overdue_notification_time ?? "21:00");
    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Control which emails you receive and when overdue reminders send.</CardDescription>
        </CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Daily reminder time (uses the timezone above). Defaults to 9:00 PM.
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleNotificationToggle("notify_task_assignment", checked, setNotifyAssignment, notifyAssignment)
                }
              />
            </div>
            <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleNotificationToggle("notify_overdue_tasks", checked, setNotifyOverdue, notifyOverdue)
                }
              />
            </div>
          </div>

...
import type {
  ...
  ListMyWikisApiV1MeWikisGetParams,
...
export const listMyWikisApiV1MeWikisGet = (
  params?: ListMyWikisApiV1MeWikisGetParams,
  options?: SecondParameter<typeof apiMutator>,
  signal?: AbortSignal
) => {
  return apiMutator<WikiListResponse>(
    { url: `/api/v1/me/wikis`, method: "GET", params, signal },
    options
  );
};

export const getListMyWikisApiV1MeWikisGetQueryKey = (
  params?: ListMyWikisApiV1MeWikisGetParams
) => {
  return [`/api/v1/me/wikis`, ...(params ? [params] : [])] as const;
};

export const getListMyWikisApiV1MeWikisGetQueryOptions = <
  TData = Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>,
  TError = ErrorType<HTTPValidationError>,
>(
  params?: ListMyWikisApiV1MeWikisGetParams,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>, TError, TData>
    >;
    request?: SecondParameter<typeof apiMutator>;
  }
) => {
  ...
  const queryKey = queryOptions?.queryKey ?? getListMyWikisApiV1MeWikisGetQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>> = ({
    signal,
  }) => listMyWikisApiV1MeWikisGet(params, requestOptions, signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type ListMyWikisApiV1MeWikisGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>
>;
export type ListMyWikisApiV1MeWikisGetQueryError = ErrorType<HTTPValidationError>;

export function useListMyWikisApiV1MeWikisGet<
  TData = Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>,
  TError = ErrorType<HTTPValidationError>,
>(
  params: undefined | ListMyWikisApiV1MeWikisGetParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof listMyWikisApiV1MeWikisGet>>, TError, TData>
    > &
...
>(
  ...
  const queryOptions = getListMyWikisApiV1MeWikisGetQueryOptions(params, options);

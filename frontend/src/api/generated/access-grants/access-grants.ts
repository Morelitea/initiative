...
export const breakGlassAccessApiV1AccessGrantsBreakGlassPost = (
  ...
  return apiMutator<AccessGrantRead>(
    {
      url: `/api/v1/access-grants/break-glass`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["breakGlassAccessApiV1AccessGrantsBreakGlassPost"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export const beginBreakGlassPasskeyApiV1AccessGrantsBreakGlassPasskeyPost = (
  ...
  return apiMutator<PasskeyAuthenticationOptions>(
    { url: `/api/v1/access-grants/break-glass/passkey`, method: "POST", signal },
    options
  );
};
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["beginBreakGlassPasskeyApiV1AccessGrantsBreakGlassPasskeyPost"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }

 ...
 */
export const liftSignInLockApiV1OperatorUsersUserIdSignInLockDelete = (
  userId: number,
  options?: SecondParameter<typeof apiMutator>,
  signal?: AbortSignal
) => {
...
export const getLiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationKey = () =>
  ["liftSignInLockApiV1OperatorUsersUserIdSignInLockDelete"] as const;

export const getLiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationOptions = <
  TError = ErrorType<HTTPValidationError>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof liftSignInLockApiV1OperatorUsersUserIdSignInLockDelete>>,
    TError,
    LiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiMutator>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getLiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  > = (props) => {
    ...
    return liftSignInLockApiV1OperatorUsersUserIdSignInLockDelete(userId, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type LiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationResult = NonNullable<
  Awaited<ReturnType<typeof liftSignInLockApiV1OperatorUsersUserIdSignInLockDelete>>
>;

export type LiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationError =
  ErrorType<HTTPValidationError>;
export type LiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationVariables = {
  userId: number;
};
 ...
 * @summary Lift Sign In Lock
 */
export const useLiftSignInLockApiV1OperatorUsersUserIdSignInLockDelete = <
  TError = ErrorType<HTTPValidationError>,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getLiftSignInLockApiV1OperatorUsersUserIdSignInLockDeleteMutationOptions(options),
    queryClient
  );
};
/**

...
class ImportEngineMessages:
    ...
    #: A people step answered with somebody else's account by an importer
    #: who may match people only to themselves.
    IMPORT_PEOPLE_MAP_SELF_ONLY = "IMPORT_PEOPLE_MAP_SELF_ONLY"

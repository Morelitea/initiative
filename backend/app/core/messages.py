...
class CalendarEventMessages:
    ...
    PERMISSION_REQUIRED = "CALENDAR_EVENT_PERMISSION_REQUIRED"
    OWNER_REQUIRED = "CALENDAR_EVENT_OWNER_REQUIRED"
    WRITE_ACCESS_REQUIRED = "CALENDAR_EVENT_WRITE_ACCESS_REQUIRED"
    GRANT_CANNOT_MANAGE_MEMBERS = "CALENDAR_EVENT_GRANT_CANNOT_MANAGE_MEMBERS"

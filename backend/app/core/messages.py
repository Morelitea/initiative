...
class AutomationsMessages:
    FEATURE_DISABLED = "AUTOMATIONS_NOT_ENABLED"
    INFRA_FEATURE_DISABLED = "AUTOMATIONS_INFRA_DISABLED"
    FLOW_NOT_FOUND = "AUTOMATION_FLOW_NOT_FOUND"
    RUN_NOT_FOUND = "AUTOMATION_RUN_NOT_FOUND"
    INVALID_FLOW_GRAPH = "AUTOMATION_INVALID_FLOW_GRAPH"

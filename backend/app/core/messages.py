...
class AuthMessages:
    ...
    #: This address has had too many wrong passwords lately to take another
    #: one yet. Other ways of signing in are unaffected.
    SIGN_IN_ATTEMPTS_EXHAUSTED = "SIGN_IN_ATTEMPTS_EXHAUSTED"

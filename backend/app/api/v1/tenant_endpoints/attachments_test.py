...
@pytest.mark.parametrize(
    ...
    [
        b"\xef\xbb\xbf",
        b"<!-- generated by an editor -->\n",
        b'<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" '
        b'"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n',
    ],
)
async def test_upload_accepts_svg_document_prologs(
    client: AsyncClient, acting_user, prefix: bytes
):
    a = await acting_user(guild_role=GuildRole.admin)
    svg = prefix + b'<svg xmlns="http://www.w3.org/2000/svg"></svg>'

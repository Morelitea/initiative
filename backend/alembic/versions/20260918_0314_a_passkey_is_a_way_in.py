"""The vocabulary of ways in gains the passkey.
...
require of a sign-in (``guild_auth_policies.require_methods``). A passkey
belongs in it — it opens a session on its own, and both of those questions can
sensibly be asked about it.
...
Revision ID: 20260918_0314
Revises: 20260918_0313
Create Date: 2026-09-18
"""

from alembic import op

revision = "20260918_0314"
down_revision = "20260918_0313"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.execute("ALTER TYPE public.login_method ADD VALUE IF NOT EXISTS 'passkey'")

...
- **A wardrobe to fill it from.** Twenty-one packs ship with the app — Sports, Pets, Plants, Pride, Disability, Multicultural, Travel, First Nations, Black heritage, Nature, Fitness, Winter, Zen, Gaming, Books, Tea, Drama, Cinema, Spooky, Observatory and Soundcheck — each with banners, frames and trophies you can wear in any combination, and most of them carrying several of each. Pride flies a flag, a frame and a heart for seven identities; Multicultural carries thirty-two flags; Disability has a trophy for eleven of the things people are, with banners for the community rather than any one of them. Take a pack in the marketplace and click any card to see everything in it. Two frames leave their colour to you: the gilded one takes a colour and the split one takes two.

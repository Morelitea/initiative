...
- **Erasing an account removes its name from wiki pages** — mentions of an erased account in wiki pages kept its name. They now read "Deleted user", as they already did in documents and notices.

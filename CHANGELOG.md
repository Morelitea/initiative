...
- **Imports ask who your assignees are** — the step that asks who each person in an import is here only listed people who had written comments. Somebody who was only ever assigned tasks was skipped, and the import went ahead and told you afterwards that it couldn't match them, leaving their tasks unassigned. They're on the list now, for imported projects and for community backups taken from now on, and the tasks go to whoever you pick.

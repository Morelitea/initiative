...
- Data export: every tool — documents, projects, tasks, queues, and counter groups — can be exported straight from its page in type-appropriate formats.
  ...
  - Importable backups: `.lexical` files for editor documents, standard Excalidraw files for whiteboards, the original file for uploads, and JSON envelopes for spreadsheets, smart links, projects, queues, and counter groups. Whiteboards additionally export PNG/SVG images, rendered in the browser.

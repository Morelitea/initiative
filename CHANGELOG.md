...
- **Velocity dashboard widget.** Work finished per week as a chart — bars, a line, or an area — with the latest week measured against the one before and the running average beside it. Quiet weeks show as zero rather than disappearing.

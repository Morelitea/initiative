...
- **Leaderboard dashboard widget.** Ranked standings for an initiative: who has finished the most, with what each person still has open beside it. Point it at a grouped task count instead and it ranks whatever the count grouped by.

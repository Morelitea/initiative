...
- Fixed invalid nested-button markup in the tag picker: the removable tag chips shown in the picker's trigger no longer sit inside a `<button>`, which React flagged as a hydration error.

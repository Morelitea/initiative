...
- **Agenda dashboard widget.** The next things in order: upcoming and in-progress calendar events, or open tasks by due date with late ones flagged as overdue. Finished work and events already over drop out on their own.

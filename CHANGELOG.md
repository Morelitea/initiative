...
- **The age question guards one button, and the minimum is now 16** — an account that had not answered was held on a date-of-birth screen with the whole app behind it, including the communities it had been invited to and had been using for months. Being put in a listed community is not the same as walking into one, and an invite is the community's call to make. The question is now asked at the one place it is for: the Join button on a community anyone signed in can find. Answer it and you join; close it and everything else carries on exactly as it was. Nobody who has already answered is asked again.

...
- **Workload dashboard widget.** Open work per person as a stacked bar — to-do against in-progress, heaviest load first — with unassigned work standing in its own column, so imbalances and orphaned tasks are visible at a glance. Finished work stays out of the picture.

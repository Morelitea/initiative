...
- **Documents reconnect like the rest of the app** — a document you are editing now notices a connection that has quietly stopped and reconnects, and every live page reconnects as soon as your network is back. If your edit access is taken away while a document is open, it stays open for reading instead of live editing switching off.

...
Every project you can access, across all your communities — a fast way to jump to one without switching communities first.
...
Your events **and** dated tasks from across every community, on one calendar. The single best place to see your whole schedule in one glance.

...
**A community can hold itself to a stricter one.** The switch is theirs, not yours: it's under that community's own **Settings → Authentication**, and it's twelve hours — the figure HIPAA and NIST both land on. Its members then sign in again on that schedule whatever your own number says, and being in two such communities is still twelve hours, not six.
